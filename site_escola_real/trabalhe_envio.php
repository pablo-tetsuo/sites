...
if($_SESSION['captcha'] == $_POST['captcha']){
	...
	$nome = 'Escola Real';	
	$assunto = "Currículo - enviado pelo Site Escola Real";
	$mensagem = "Recebemos uma mensagem no site na página Trabalhe Conosco<br/>
	...
	$mail->AddAttachment($arquivo['tmp_name'], $arquivo['name']  );
		if(!$mail->Send()){	
			...
			echo "<script>alert('$msg');window.location.assign('trabalhe.php');</script>";
			}else{
				$msg = "Obrigado por enviar seu Currículo.";
				echo "<script>alert('$msg');
				window.location.assign('trabalhe.php');</script>";
			}
} else {
