...
<section id="contato_pagina" class="section-body" style="background-color: rgb(233, 255, 242);">
<div class="container">
    <br><br><br><br><br>
...
<form action="contato_envio.php" method="POST" role="form" enctype="multipart/form-data" class="contactForm">      
