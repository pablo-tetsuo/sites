...
<div class="container-fluid" id="intro" style="background-image: url('img/backgroundheader.jpg');">
	...
	<div id="intro_titulos">
      <div id="titulo_intro">Flacidez</div>
	  <hr id="linha_intro">
	</div>
	<center>
</div>
...
<section>
	...
	<div class="container-fluid" id="titulo-tipo-tratamento">
		<h3 id="titulo-tipo-tratamento-conteudo">Tratamento para Flacidez</h3>
	</div>
	</center>
...
<section>
	<div class="container" id="texto-video">
		...
		A flacidez se caracteriza pela perda de tonicidade da pele e dos músculos, e ocorre quando as fibras de sustentação começam a enfraquecer. Essas fibras são o colágeno e a elastina, duas proteínas sintetizadas pelo nosso próprio organismo a partir das proteínas em nossa alimentação.
		</p>

		<p id="texto-video-paragrafo">
		A perda de colágeno e de água são duas das principais causas da perda de elasticidade da pele, e aumenta à medida que envelhecemos. O processo de envelhecimento se inicia por volta do 30 anos quando se começa a perder 5% a cada 5 anos em quantidade e qualidade destas proteínas (colágeno).
		</p>
...
<section>
	...
	<div class="col-md-12">
		<br>
		<center>
		<img src="img/tratamentos/flacidez/flacidez.jpg" class="img-fluid">
		</center>
		<br>
	</div>
	...
	<div class="container" id="texto-video">
		...
		<ul>
		<li>Radiofrequência
		<li>Ultrassom micro focado
		<li>Nd Yag + Erbium Yag 4D
		<li>Fios de sustentação
		<li>Fillers para estímulo de colágeno
		<li>Infravermelho profundo
		<li>Dermaroller
		<li>Laser fracionado Semi Ablativo
