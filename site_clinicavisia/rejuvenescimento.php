...
<div class="container-fluid" id="intro" style="background-image: url('img/backgroundheader.jpg');">
	...
	<div id="intro_titulos">
      <div id="titulo_intro">Rejuvenescimento</div>
	  <hr id="linha_intro">
	</div>
	<center>
</div>
...
<section>
	...
	<div class="container-fluid" id="titulo-tipo-tratamento">
		<h3 id="titulo-tipo-tratamento-conteudo">Tratamento para Rugas</h3>
	</div>
	</center>
...
<section>
	<div class="container" id="texto-video">
		...
		As rugas ou linhas de expressão são marcas causadas pela movimentação repetitiva dos músculos do rosto. Exposição solar excessiva aos raios ultravioletas, estresse, fumo, álcool e má alimentação são alguns exemplos de influenciadores desses sinais..
		</p>

		<p id="texto-video-paragrafo">
		As rugas , manchas e lesões pigmentadas aparecem. O problema é que a exposição ao sol que você teve na infância tem efeito cumulativo e o dano causado quando você tinha poucos anos de vida surgirão invConforme os anos passam, as expressões deixam marcas na pele – que podem ser as chamadas linhas, mais leves, ou até rugas mais profundas. A perda de produção e qualidade do colágeno iniciada aos 30 anos de idade é uma importante razão para o aparecimento das rugas.
		</p>

		<p id="texto-video-paragrafo">
		Classificamos 2 tipos especiais de rugas : estáticas (que quando em repouso estão aparentes) e dinâmicas (surgem ao movimento). As primeiras podem aparecer nos locais de movimento (secundárias ao movimento) mas em geral, seu tratamento é totalmente diferente das rugas dinâmicas.
		Rugas estáticas exigem técnicas de rejuvenescimento com laser, preenchimentos, biomoduladores de colágeno, etc. As rugas dinâmicas são tratadas quase que exclusivamente pela toxina botulínica (Botox, Dysport, Botulift,) que bloqueia os movimentos musculares temporariamente o que conferirá ao paciente uma pele menos marcada.
		</p>
...
<section>
	...
	<div class="col-md-12">
		<br>
		<center>
		<img src="img/tratamentos/rejuvenescimento/rejuvenescimento.jpg" class="img-fluid">
		</center>
		<br>
	</div>
	...
	<div class="container" id="texto-video">
		<p id="texto-video-paragrafo">
		<ul>
			<li>Toxina botulínica
			<li>Ácido hialurônico
			<li>Hidroxiapatita de cálcio
			<li>Intradermoterapia
			<li>Fios de sustentação
			<li>Biomoduladores
			<li>Fios de PDO
			<li>Radiofrequência uni, bi e multipolar
			<li>Fios de PDO
			<li>Infravermelho
			<li>Preenchedores
		</ul>
