...
<div class="container-fluid" id="intro" style="background-image: url('img/backgroundheader.jpg');">
	...
	<div id="intro_titulos">
      <div id="titulo_intro">Estrias</div>
	  <hr id="linha_intro">
	</div>
	<center>
</div>
...
<section>
	...
	<div class="container-fluid" id="titulo-tipo-tratamento">
		<h3 id="titulo-tipo-tratamento-conteudo">O que são as Estrias?</h3>
	</div>
	</center>
...
<section>
	<div class="container" id="texto-video">
		...
		As estrias são cicatrizes que se formam quando há destruição de fibras elásticas e colágenas por estiramento máximo da pele.. 
		As linhas são formadas por causa da diminuição da espessura da derme e da epiderme( afinamento ). Elas podem coçar e arder, 
		mas em geral não apresentam sintomas com seu aparecimento.
		</p>

		<p id="texto-video-paragrafo">
		Frequentemente aparece por um aumento do volume corpóreo após gravidez, aumento de peso, colocação de próteses mamárias, 
		fatores hormonais como o uso de estrógeno, anticoncepcional e hormônios adrenocorticais (corticóides). 
		O uso prolongado de tratamentos com corticoides também podem desencadear estrias no corpo.
		</p>

		<p id="texto-video-paragrafo">
		Em mulheres, as áreas mais comuns são nos flancos, coxas, glúteos, abdômen e nos seios. 
		Acontece muito quando a mulher entra na puberdade, cresce muito rápido, ou ganha peso em um curto espaço de tempo. 
		Na fase adulta, durante a gravidez podem aparecer estrias no abdômen e nos seios. Outra causa comum, hoje, 
		é o aparecimento após a colocação de próteses de silicone, por causa da distensão dos tecidos de forma abrupta.
		</p>

		<p id="texto-video-paragrafo">
		Nos homens é mais comum nos ombros, braços e costas. Os que se submetem aos exercícios de musculação excessiva ou 
		abusam de anabolizantes são os mais propensos. Em homens o ganho de peso e o crescimento abrupto também são causas de estrias.
		</p>
	</div>	
...
<section>
	...
	<div class="col-md-12">
		<br>
		<center>
		<img src="img/tratamentos/estrias/estrias_exemplo.jpg" class="img-fluid">
		</center>
		<br>
	</div>
	...
	<div class="container" id="texto-video">
		<ul>
			<li>Laser CO2 Fracionado</li>
			<li>Peelings</li>
			<li>Preenchimentos</li>
			<li>Mesoterapia</li>
			<li>Dermopigmentação médica</li>
			<li>Laser NdYag e Herbiun semi ablativos</li>
		</ul>
	</div>
